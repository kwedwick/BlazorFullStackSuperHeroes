...
namespace BlazorFullStackCrud.Server.Controllers
{
    ...
    public class SuperHeroController : ControllerBase
    {
        ...
        {
            var heroes = await _context.SuperHeroes.Include(hero => hero.Comic).ToListAsync();
            return Ok(heroes);
        }
        ...
        public async Task<ActionResult<SuperHero>> UpdateSuperHero(SuperHero hero, int id)
        {
            ...
            if(dbHero == null)
            {
                return NotFound("No hero was found :(");
            }
        ...
        {
            return await _context.SuperHeroes.Include(hero => hero.Comic).ToListAsync();
        }
    }
}
